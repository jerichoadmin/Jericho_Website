...
module.exports = {
    PreviewTable : sequelize.define('previewtable', {
        previewtableid: {
        ...
        img_8_title: DataTypes.TEXT,
        img_9_captions: DataTypes.TEXT,
        img_9_title: DataTypes.TEXT,
        img_10_captions: DataTypes.TEXT,
        img_1_alt_text: DataTypes.TEXT,
        img_2_alt_text: DataTypes.TEXT,
        img_3_alt_text: DataTypes.TEXT,
        img_4_alt_text: DataTypes.TEXT,
        img_5_alt_text: DataTypes.TEXT,
        img_6_alt_text: DataTypes.TEXT,
        img_7_alt_text: DataTypes.TEXT,
        img_8_alt_text: DataTypes.TEXT,
        img_9_alt_text: DataTypes.TEXT,
        img_10_alt_text: DataTypes.TEXT,
        link: DataTypes.TEXT,
